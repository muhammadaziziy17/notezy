        ...
        <div class="flex justify-center">
            <div class="w-full max-w-3xl bg-base-100 rounded-xl shadow-md border border-base-300 p-6">
                <form action="{{ route('note_update') }}" method="POST">
                    @csrf
                    <input type="hidden" name="note_id" value="{{ $archived_note->id }}">
                    ...
                    <div class="mb-4">
                        ...
                        <input type="text" name="new_note_title_value" id="new_note_title_value"
                            class="input input-bordered w-full" value="{{ $archived_note->note_title }}" disabled />
                        <input type="hidden" id="old_note_title_value" value="{{ $archived_note->note_title }}">
                    </div>
                    ...
                    <div class="mb-4">
                        ...
                        <textarea id="new_note_text_value" name="new_note_text_value" class="textarea textarea-bordered w-full h-40" disabled>{{ $archived_note->note_text }}</textarea>
                        <input type="hidden" id="old_note_text_value" value="{{ $archived_note->note_text }}">
                    </div>
                    ...
                    <div class="mb-6">
                        ...
                        <input type="hidden" id="old_note_type_value" value="{{ $archived_note->note_type }}">
                    </div>
                    ...
                    <div class="flex flex-wrap justify-center gap-4 mt-4">
                        ...
                        <a href="{{ route('restore_archived_note', ['id' => $archived_note->id]) }}" class="btn btn-primary"
